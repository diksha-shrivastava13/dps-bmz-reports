...
st.markdown("<h1 style='text-align: center;'>⏳ Portfolio Navigator: Yearly Project Reports </h1>",
...
if uploaded_file is None:
    ...
    try:
        ...
        response = requests.post(
            "https://dps-ai-prod.bluemoss-c00786e0.germanywestcentral.azurecontainerapps.io/api/project/report/",
            files=files
        )
